            ...
            <main className="overflow-hidden">
                <section className="relative">
                    <PixelTrail 
                        ...
                        fadeDuration={1000}
                        delay={0}
                        pixelClassName="rounded-full bg-red-900/40 border border-red-700/30"
                        className="absolute inset-0 pointer-events-auto z-0"
                    />
                    <div className="relative mx-auto max-w-6xl px-6 pt-32 lg:pb-16 lg:pt-48 z-20">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            >
                                <h1
                                    ...
                                    Manufacture Your Distribution
                                </h1>

                                <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg">
                                    A personal command center to operationalize your distribution playbook. Turn strategy into a daily, gamified ritual.
                                </p>
                            </AnimatedGroup>
                        </div>
                    </div>
